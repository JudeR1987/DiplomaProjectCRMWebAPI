...
public class EmployeeConfiguration : IEntityTypeConfiguration<Employee>
{
    void IEntityTypeConfiguration<Employee>.Configure(EntityTypeBuilder<Employee> builder) {
        ...
        var employees = new List<Employee>{
            new() { Id =  1, Name = "Оксана",    UserId = 3, CompanyId = 1, SpecializationId = 1, PositionId = 6, Rating = 5, Avatar = "http://localhost:5297/download/getphoto/employees/photos/employee001_31710.jpg", Deleted = null },
            new() { Id =  2, Name = "Марина",    UserId = 4, CompanyId = 1, SpecializationId = 3, PositionId = 6, Rating = 4, Avatar = "http://localhost:5297/download/getphoto/employees/photos/employee002_31720.jpg", Deleted = null },
            new() { Id =  3, Name = "Тамара",    UserId = 5, CompanyId = 2, SpecializationId = 3, PositionId = 6, Rating = 5, Avatar = "http://localhost:5297/download/getphoto/employees/photos/employee003_31730.jpg", Deleted = null },
            new() { Id =  4, Name = "Милана",    UserId = 6, CompanyId = 2, SpecializationId = 1, PositionId = 3, Rating = 0, Avatar = "http://localhost:5297/download/getphoto/employees/photos/employee004_31740.jpg", Deleted = null },
            new() { Id =  5, Name = "Екатерина", UserId = 7, CompanyId = 2, SpecializationId = 1, PositionId = 6, Rating = 4, Avatar = "http://localhost:5297/download/getphoto/employees/photos/employee005_31750.jpg", Deleted = null },
            new() { Id =  6, Name = "Виктория",  UserId = 8, CompanyId = 3, SpecializationId = 2, PositionId = 6, Rating = 5, Avatar = "http://localhost:5297/download/getphoto/employees/photos/employee006_31760.jpg", Deleted = null },
            new() { Id =  7, Name = "Кристина",  UserId = 2, CompanyId = 4, SpecializationId = 5, PositionId = 6, Rating = 3, Avatar = "http://localhost:5297/download/getphoto/employees/photos/employee007_31770.jpg", Deleted = Utils.GetRandomDateTime() }
        };
